                    ...
                    <div class="card-body">
                        <h3 class="card-title">{{ $equipo->nombre }}</h5>
                          @if($equipo->score!=null)
                            <p style="color:red;" class="card-title">Ya Esta Calculado</p>
                          @endif
                          @if($equipo->tecnicos==0)
                            <p style="color:green;" class="card-title">Faltan los criterios tecnicos</p>
                          @endif
                          @if($equipo->clinicos==0)
                            <p style="color:green;" class="card-title">Faltan los criterios clinicos</p>
                          @endif
